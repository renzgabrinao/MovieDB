...
import { addToLocalStorage, removeFromLocalStorage, ifMovieInFavourites, getFavouriteMovies } from '../data/utilities';
    ...
    return (
      <div className='movie-item'>
        <div className='movie-item-details'>
          <img src={'https://image.tmdb.org/t/p/w780' + movie.poster_path} alt={'Poster for ' + movie.original_title}/>
